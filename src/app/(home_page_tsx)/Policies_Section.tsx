                    ...
                    <div className='border-[1px] border-[#DEDEDE] w-full rounded-[12px] p-5 '>
                        <div className=' grid grid-cols-11 items-center justify-center py-2.5 mb-2.5 border-b-2 border-[#DEDEDE]'>
                            ...
                            <div className=' col-span-5'>
                                <h3 className=' text-lg  md:text-2xl font-[400] text-[#252525] '>Check-in</h3>
                            </div>
                            {/* right section */}
                        ...
                        <div className=' grid grid-cols-11 items-center justify-center py-2.5 mb-2.5 border-b-2 border-[#DEDEDE]'>
                            {/* left site */}
                            <div className=' col-span-5'>
                                <h3 className='text-lg  md:text-2xl font-[400] text-[#252525]'>Check-out</h3>
                            </div>
                            {/* right section */}
                            <div className=' col-span-6'>
                                <h3 className=' text-sm md:text-[16px] font-semibold text-[#252525] pb-3 md:pb-0'>Available 24 hours</h3>
                        ...
                        <div className=' grid grid-cols-11 items-center justify-center py-2.5 mb-2.5 border-b-2 border-[#DEDEDE]'>
                            {/* left site */}
                            <div className=' col-span-5'>
                                <h3 className=' text-lg  md:text-2xl font-[400] text-[#252525]'>Cancellation/ prepayment</h3>
                            </div>
                            {/* right section */}
                            <div className=' col-span-6'>
                        ...
                        <div className=' grid grid-cols-11 items-center justify-center py-2.5 mb-2.5 border-b-2 border-[#DEDEDE]'>
                            {/* left site */}
                            <div className=' col-span-5'>
                                <h3 className=' text-lg  md:text-2xl font-[400] text-[#252525]'>Children and beds</h3>
                            </div>
                            {/* right section */}
                            <div className=' col-span-6'>
                                <h3 className='text-sm md:text-[16px] font-semibold text-[#252525] pb-3 md:pb-0'>Child policies</h3>
                                <p className='text-sm md:text-[16px] text-[#626262] font-[400]'>
                                ...
                                <h3 className=' text-sm md:text-[16px] font-semibold text-[#252525] pb-3 md:pb-0'>Cot and extra bed policies</h3>
                                <p className='text-sm md:text-[16px] text-[#626262] font-[400]'>
                        ...
                        <div className=' grid grid-cols-11 items-center justify-center py-2.5 mb-2.5 border-b-2 border-[#DEDEDE]'>
                            {/* left site */}
                            <div className=' col-span-5'>
                                <h3 className='text-lg  md:text-2xl font-[400] text-[#252525]'>No age restriction</h3>
                            </div>
                            {/* right section */}
                            <div className=' col-span-6'>
                        ...
                        <div className=' grid grid-cols-11 items-center justify-center py-2.5 mb-2.5 border-b-2 border-[#DEDEDE]'>
                            {/* left site */}
                            <div className=' col-span-5'>
                                <h3 className='text-lg  md:text-2xl font-[400] text-[#252525]'>Pets</h3>
                            </div>
                            {/* right section */}
                            <div className=' col-span-6'>
                                <p className='text-sm md:text-[16px] text-[#626262] font-[400]'>
                        ...
                        <div className=' grid grid-cols-11 items-center justify-center py-2.5 mb-2.5 '>
                            {/* left site */}
                            <div className=' col-span-5'>
                                <h3 className='text-lg  md:text-2xl font-[400] text-[#252525]'>Cash only</h3>
                            </div>
                            {/* right section */}
                            <div className=' col-span-6'>
                                <p className='text-sm md:text-[16px] text-[#626262] font-[400]'>
