    ...
    return (
        <div className='bg-white pt-[30px]'>
            <div className="  max-w-7xl mx-auto px-2.5 lg:px-[88px]  ">
                ...
                <div className=' flex flex-col-reverse md:grid md:grid-cols-2 gap-x-14'>
                    {/* text section */}
                    <div className=' lg:col-span-1 grid grid-cols-2 gap-x-7 md:gap-x-14'>
                        {/* left section */}
                        <div>
                            <h3 className=' flex gap-x-2 items-center pb-3'>
                                <span className=' text-[16px] text-[#7D7D7D]'><BiSolidBowlHot /></span>
                                <span className='text-sm md:text-[16px] text-[#252525] font-[400]'>Restaurants & cafes</span>
                        ...
                        <div>
                            <h3 className=' flex gap-x-2 items-center justify-start pb-3 '>
                                ...
                                <span className=' text-sm md:text-[16px] text-[#252525] font-[400]'>Shops & Markets</span>
                        ...
                        <div className=' pt-5'>
                            <h3 className=' flex gap-x-2 items-center pb-3'>
                                ...
                                <span className='text-sm md:text-[16px] text-[#252525] font-[400]'>Beaches</span>
                        ...
                        <div className=' pt-5'>
                            <h3 className=' flex gap-x-2 items-center pb-3'>
                                ...
                                <span className=' text-sm md:text-[16px] text-[#252525] font-[400]'>Public transport</span>
                    ...
                    <div className=' lg:col-span-1'>
                        <div className=' h-[287px]  '>
                            ...
                            <div className=' bg-white h-12 md:h-[90px] content-center rounded-b-[12px] shadow-lg shadow-[#e7e7e7]'>
                                <p className='text-sm md:text-lg font-[400] text-[#007DD0] text-center'>Explore the Area</p>
                            </div>
                        </div>
                    </div>
